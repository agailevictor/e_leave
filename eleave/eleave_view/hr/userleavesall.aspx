<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userleavesall.aspx.cs" Inherits="eleave_view.hr.userleavesall" MasterPageFile="~/hr/hr.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="table-responsive">
        <asp:GridView ID="grd_userleaves" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="False">
            <Columns>
