<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leavetaken.aspx.cs" Inherits="eleave_view.hr.leavetaken" MasterPageFile="~/hr/hr.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="table-responsive">
        <asp:GridView ID="grd_ltaken" runat="server" CssClass="table table-bordered table-hover" OnPreRender="grd_ltaken_PreRender" AutoGenerateColumns="False" ClientIDMode="Static">
            <Columns>
